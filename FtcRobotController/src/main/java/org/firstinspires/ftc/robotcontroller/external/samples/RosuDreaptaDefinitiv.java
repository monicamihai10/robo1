...
@Autonomous(name="RDD", group="Pushbot")
public class RosuDreaptaDefinitiv extends LinearOpMode {
    ...
    I2cAddr a1 = I2cAddr.create7bit(0x28);
    I2cAddr a2 = I2cAddr.create7bit(0x26);
    ...
    public void runOpMode() {
       ...
       // range_sensorf = new RangeSensorWrapper("fata", hardwareMap, a2, telemetry);
        ...
        if (Vuforia_cit == 'l') {
            ...
            if (!opModeIsActive()) return;
            basculare(0.25);
        } else if (Vuforia_cit == 'r') {
            GoTo(0.1, 10);
            sleep(50);
            GoTo(0.4, 800); //la hub 1000
            sleep(500);
            if (!opModeIsActive()) return;
    ...
    public void Rotire90(double speed, double leftInches, double rightInches, double timeoutS){              //ROTIRE -90;
        int newLeftTarget = 0;
        int newRightTarget = 0;
        ...
        if (opModeIsActive() ) {
            ...
            // Determine new target position, and pass to motor controller
            newLeftTarget = robot.roatast.getCurrentPosition() + (int) (leftInches * COUNTS_PER_INCH);
            newRightTarget = robot.roatadr.getCurrentPosition() - (int) (rightInches * COUNTS_PER_INCH);
            robot.roatast.setTargetPosition(newLeftTarget);
            robot.roatadr.setTargetPosition(newRightTarget);
